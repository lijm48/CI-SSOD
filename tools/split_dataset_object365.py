...
def main():
    ...
    root_dir = '/root/paddlejob/workspace/env_run/output/lijiaming/dataset/Object365/'
    data_set = 'zhiyuan_objv2_train'
    ...
    # original statistics
    with open("../../coco/object365_novel2.txt", "r") as f:  # 打开文件
    ...
    output_file_label = '{}{}_object365_label.json'.format(root_dir, data_set)
    ## save to json
    ...
    output_file_unlabel = '{}{}_object365_unlabel.json'.format(root_dir, data_set)
    import pdb;pdb.set_trace()
    ## save to json
