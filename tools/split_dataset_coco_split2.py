...
from ssod.datasets.cate import  COCO_NOVEL_CATEGORIES_2
...
def main():
    ...
    novel_ids = [k["id"] for k in COCO_NOVEL_CATEGORIES_2 if k["isthing"] == 1]
    # original statistics
    with open("../../coco/base_10percent_split3.txt", "r") as f:  # 打开文件
        labeled_list = f.readlines() 
    with open("../../coco/novel_few_split3.txt", "r") as f:  # 打开文件
    ...
    output_file_label = '{}{}_coco_split2_label.json'.format(root_dir, data_set)
    ## save to json
    ...
    output_file_unlabel = '{}{}_coco_split2_unlabel.json'.format(root_dir, data_set)
    import pdb;pdb.set_trace()
    ## save to json
